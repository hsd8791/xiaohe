    ...
    <div class="container">
      <div class="wraper">
        ...
        <el-select :disabled='!editing' v-model="education" placeholder="请选择">
          <el-option v-for="item in options.education" :key="item.value" :label="item.label" :value="item.value"></el-option>
        </el-select>
      </div>
      <div class="wraper">
        <label>婚姻状况：</label>
        <el-select :disabled='!editing' v-model="marriage" placeholder="请选择">
          <el-option v-for="item in options.marriage" :key="item.value" :label="item.label" :value="item.value"></el-option>
        </el-select>
      </div>
      <div class="wraper">
        <label>子女情况：</label>
        <el-select :disabled='!editing' v-model="kids" placeholder="请选择">
          <el-option v-for="item in options.kids" :key="item.value" :label="item.label" :value="item.value"></el-option>
        </el-select>
      </div>
    </div>
    <div class="container">
      ...
      <div class=" residence">
        ...
        <div class="wraper ">
          ...
          <el-select :disabled='!editing' v-model="district" placeholder="县级市/区" class='district'>
            <el-option v-for="item in options.district" :key="item.value" :label="item.label" :value="item.value"></el-option>
          </el-select>
        </div>
        <div class="wraper">
          <label>详细地址</label>
