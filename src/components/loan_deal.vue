	...
	<div id="loanDealVue">
      ...
      <div v-if='!showUnspay'>
        ...
        <div class="guide" v-if='action=="repay"'>
          ...
          <p>或者联系指定微信号【小海带：13868562997】，微信或支付宝支付费用还款，借贷宝再进行销账。</p>
        </div>
        <div class="guide" v-if='action=="renewal"'>
          <div v-if='lendingWay==="借贷宝"'>
            <p>向指定微信或支付宝【小海带：13868562997】支付续期费用300元后，我们将在借贷宝里发起展期。请再去借贷宝点击展期确认。</p>
          </div>
          <div v-if='lendingWay==="今借到"'>
            <p>向指定微信或支付宝【小海带：13868562997】支付续期费用300元后，再去今借到发布一笔新借款1000元7天0利率0服务费，会借你一笔新的借款，收到新借款【不要提现】再去还上笔到期的借款，完成续期。</p>
          </div>
          <div v-if='lendingWay==="无忧借条"'>
            <p>向指定微信或支付宝【小海带：13868562997】支付续期费用300元后，再进入无忧借条APP——点击借条中心——点击（我欠谁钱）——找到到期借条申请延期（利息、补偿金填0，延期补偿金填0，还款时间：延迟时长为7天）。</p>
          </div>
          <!-- <p>向指定微信或支付宝【小海带：13868562997】支付续期费用300元后，{{lendingWay}}再放款。</p> -->
        </div>
        ...
        <div class="guide" >
          <p>如有疑问请联系指定微信号【小海带：13868562997】</p>
        </div>
      </div>
